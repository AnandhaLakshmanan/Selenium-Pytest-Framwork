...
class BasePage:
    ...
    @staticmethod
    def select_option_from_static_dropdown_by_text(element: WebElement, text: str) -> None:
        """
    ...
    def wait_for_element_to_be_present(self, locator: Tuple[str, str], timeout: int = 10) -> WebElement:
        """
